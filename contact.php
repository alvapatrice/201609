	...
	<body>
		...
		?>
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="#" style="font-size:16px;">Contact</a></li>
				</ul>
											...
											<li><a href="cart.php" style="font-size:16px;"><span class="glyphicon glyphicon-shopping-cart"></span> Cart <span class="badge"style="font-size:12px;"><?php echo $cnt;?></span></a></li>
												...
												<li class="dropdown">
													...
													<ul role="menu" class="dropdown-menu">
														...
														<li>
															<form action="contact.php" role="form" class="form-inline" method="post" enctype="multipart/form-data">
		...
		<div class="container" style="background-color:#EFF1F3;width:auto;padding-bottom:80px;padding-top:80px;">	
			...
			<div class="row">
				<div class="col-lg-5 col-lg-offset-1">
					<h2>Dhaka | <a href="tel:+8801677560055" style="text-decoration:underline;">+8801677560055</a></h2>
					<address style="font-size:20px;color:gray;">
						215 Castro Street, 3rd Floor<br>
						Mountain View<br>
						California 94041
					</address>
				</div><!-- /.col-lg-4 -->
				<div class="col-lg-4">
					<h2>Chittagong | <a style="text-decoration:underline;"href="tel:+8801683439643">+8801683439643</a></h2>
					<address style="font-size:20px;color:gray;">
						# 80, Ahad Pinnacle<br>
						2nd Floor, 5th Main, 2nd Cross<br>
						5th Block, Koramangala Industrial layout<br>
						Bangalore 560095
					</address>
				</div><!-- /.col-lg-4 -->
			</div><!-- /.row -->
